/*****************************************************************************
 tetWarpBilin.c    S.R.Lines    95.05.08
...
int
warpRecFromTetBilinAcc (FloXY *flow
	, unt dW, unt dH, pDmj fD, flt pA[4][2], flt pB[4][2])
{
...
int     sP  = sM + 1, aP = aM + 1;
  ...
  { double  stds[10];
    shoStats4(stds,     wts,0,0,dW,dH,"I-CORRES stats on WTS");
    rowPclrFF(flow->acz,wts,0,0,dW,dH,0,0,dW,dH,3.0,stds[1],stds[2],0.0,255.0);
  }

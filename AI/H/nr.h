#ifndef nr_h_included /******** numerical recipes header ****************/
#define nr_h_included /******** set to ANSI default, spraxlo 93.6.28 ****/
...
#undef TRADITIONAL   /* cckr is for losers. */
#ifdef ANSI
...
#endif
#ifdef TRADITIONAL	/* #undef'd above */
	void adi();
	void amoeba();
	void anneal();
	void avevar();
...
#endif /* nr_h_included ******** numerical recipes header **************/

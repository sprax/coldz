...
void main(void)
{
    ...
    */
    ...
    p = a;
    printf("a+3 = %x, &*(a+3) = %x, *(a+3) = %x, a[3] = %x\n", (unsigned int)a + 3, (unsigned int)&*(a + 3), (unsigned int)*(a + 3), a[3]);
    printf("p+3 = %x, &*(p+3) = %x, *(p+3) = %x, p[3] = %x\n", (unsigned int)p + 3, (unsigned int)&*(p + 3), (unsigned int)*(p + 3), p[3]);
...
#define GOOF 5
    ...
    q = "string";
    p[3] = 'o';
    printf("p & q: %x<%s> %x<%s>  %x<%s>  %c\n", (unsigned int)&p, p, (unsigned int)&q, q, (unsigned int)&r, r, "string"[3]);

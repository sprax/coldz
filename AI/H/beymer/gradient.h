...
#ifndef beymer_gradient_h_
#define beymer_gradient_h_
...
double canny_gradient_interpolate(int x, int y, double dx, double dy, image_t *magnitude);
...
gradient_t *make_gradient();
gradient_t *make_gradient2();
double canny_gradient_interpolate();

#endif
#endif /* beymer_gradient_h_ */

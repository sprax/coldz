...
/* #error "...iristools/include/image.h" */

extern int i_errhdlr(char *fmt, ...);
extern int iclose(register IMAGE  *image);
extern int getrow( register IMAGE *image, unsigned short *buffer
                 , register unsigned int y
                 , register unsigned int z);
extern int putrow(IMAGE *image, unsigned short *buf, unsigned y, unsigned z);


#ifdef OPEN_C__	/* The actual function def. needs full prototype */
extern IMAGE *iopen(char *file, register char *mode, unsigned type
                   ,unsigned dim, unsigned xsize, unsigned ysize
                   ,unsigned zsize);
#else
extern IMAGE *iopen(char *file, char *mode, ...);   /* WAS: register char *mode, ... */
#endif

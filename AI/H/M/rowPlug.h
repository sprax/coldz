/*****************************************************************************
rowPlug.h    S.R.Lines (spraxlo@ai.mit.edu)    93.7.11-26
...
Naming scheme for fill functions:
	...
	Plug: like Fill, but good only for single hits (collisions).  Disdained.
...
#ifndef  im_rowPlug_h__
#define  im_rowPlug_h__

void
rowPlugFlt ( ppf dstQ, ppf accW, int X, int Y, unt wide, unt tall
           , double infimum, double dmean);

void
rgbPlugFlt ( ppf dstQ, ppf accW, int X, int Y, unt wide, unt tall
           , double infimum, double dmean);

#endif   /* im_rowPlug_h__ */

#define VANILLA 1   /* but leave LINT_ARGS and ANSI undefined */
	...
	void des(struct immense, struct immense, int *, int, struct immense *);
	void ks(struct immense, int, struct great *);
	void cyfun(unsigned long, struct great, unsigned long *);
	float df1dim(float);
	...
	void laguer(struct fcomplex *, int, struct fcomplex *, float, int);
	...
	void zroots(struct fcomplex *, int, struct fcomplex *, int);
#endif
#ifdef ANSI
	...
	void amoeba(float **p, float *y, int ndim, float ftol, float (*funk)(),
		int *iter);
	...
	float brent(float ax, float bx, float cx, float (*f)(), float tol,
		float *xmin);
	...
	float dbrent(float ax, float bx, float cx, float (*f)(), float (*df)(),
		float tol, float *xmin);
	void ddpoly(float *c, int nc, float x, float *pd, int nd);
	void des(struct immense inp, struct immense key, int *newkey, int isw,
		struct immense *out);
	void ks(struct immense key, int n, struct great *kn);
	void cyfun(unsigned long ir, struct great k, unsigned long *iout);
	float df1dim(float x);
	void dfpmin(float *p, int n, float ftol, int *iter, float *fret, 
		float (*func)(), void (*dfunc)());
	void difeq(int k, int k1, int k2, int jsf, int is1, int isf, 
		int *indexv, int ne, float **s, float **y);
	void dlinmin(float *p, float *xi, int n, float *fret, float (*func)(),
		void (*dfunc)());
	void eclass(int *nf, int n, int *lista, int *listb, int m);
	void eclazz(int *nf, int n, int (*equiv)());
	...
	float golden(float ax, float bx, float cx, float (*f)(), float tol, 
		float *xmin);
	...
	void kendl2(float **tab, int i, int j, float *tau, float *z,
		float *prob);
	void ksone(float *data, int n, float (*func)(), float *d, float *prob);
	void kstwo(float *data1, int n1, float *data2, int n2, float *d,
		float *prob);
	void laguer(struct fcomplex *a, int m, struct fcomplex *x, float eps,
		int polish);
	...
	float midexp(float (*funk)(), float aa, float bb, int n);
	float midinf(float (*funk)(), float aa, float bb, int n);
	float midpnt(float (*func)(), float a, float b, int n);
	float midsql(float (*funk)(), float aa, float bb, int n);
	float midsqu(float (*funk)(), float aa, float bb, int n);
	void mmid(float *y, float *dydx, int nvar, float xs, float htot,
		int nstep, float *yout, void (*derivs)());
	...
	float qgaus(float (*func)(), float a, float b);
	float qromb(float (*func)(), float a, float b);
	float qromo(float (*func)(), float a, float b, float (*choose)());
	void qroot(float *p, int n, float *b, float *c, float eps);
	float qsimp(float (*func)(), float a, float b);
	float qtrap(float (*func)(), float a, float b);
	float quad3d(float (*func)(), float x1, float x2);
	float ran0(int *idum);
	float ran1(int *idum);
	...
	float rtbis(float (*func)(), float x1, float x2, float xacc);
	float rtflsp(float (*func)(), float x2, float x2, float xacc);
	float rtnewt(void (*funcd)(), float x1, float x2, float xacc);
	float rtsafe(void (*funcd)(), float x1, float x2, float xacc);
	float rtsec(float (*func)(), float x1, float x2, float xacc);
	void rzextr(int iest, float xest, float *yest, float *yz, float *dy,
		int nv, int nuse);
	void scrsho(float (*fx)());
	...
	int zbrac(float (*func)(), float *x1, float *x2);
	void zbrak(float (*fx)(), float x1, float x2, int n, float *xb1,
		float *xb2, int *nb);
	float zbrent(float (*func)(), float x1, float x2, float tol);
	void zroots(struct fcomplex *a, int m, struct fcomplex *roots,
		int polish);
#endif
#ifdef VANILLA
	void adi();
...
struct immense {unsigned long l,r;};
struct great {unsigned short l,c,r;};
